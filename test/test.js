...
function testBagi() {
  ...
  checkTest(
    bagi(5, 0) === "Pembagian oleh nol tidak diperbolehkan",
    "Test bagi(5, 0) failed"
  );
}
...
console.log(
  `Jumlah fungsi yang benar (semua tes berhasil): ${functionCorrectCount}`
);
console.log(
  `Jumlah fungsi yang salah (ada tes yang gagal): ${functionErrorCount}`
);
